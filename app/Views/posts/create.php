...
<html lang="en">
    ...
    <body>
        ...
        <div class="col-8" align="center">
            ...
            <span class="type1"> 交易時間&nbsp:&nbsp</span> <input id="location" style="width: 250px" required><br><br>
            <span class="type1"> 交易地點&nbsp:&nbsp</span> <input id="location" style="width: 250px" required><br><br>
            <span class="type1"> 商品類別&nbsp:&nbsp</span>
            <select id="category" name="category" class="type2" style="height:35px; width:250px" required>
            ...
            <br><br>
            <span class="type1"> 商品圖片&nbsp:&nbsp</span> <input id="image" type="file" accept="image" style="width: 200px" required><br><br>
            <p class="type1"> 商品描述&nbsp:&nbsp</p> <textarea name="describe" id="describe" cols="50" rows="10"></textarea><br><br>
